...
an iterator of 1-tuples. With no arguments, it returns an empty iterator. Equivalent to:
"""
...
"""
The left-to-right evaluation order of the iterables is guaranteed. This makes possible an idiom for
